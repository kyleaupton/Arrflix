 ...
 */
export const getV1MovieByIdDownloadCandidates = <ThrowOnError extends boolean = false>(options: Options<GetV1MovieByIdDownloadCandidatesData, ThrowOnError>) => {
    return (options.client ?? client).get<GetV1MovieByIdDownloadCandidatesResponses, GetV1MovieByIdDownloadCandidatesErrors, ThrowOnError>({
 ...
 */
export const postV1MovieByIdPreviewCandidate = <ThrowOnError extends boolean = false>(options: Options<PostV1MovieByIdPreviewCandidateData, ThrowOnError>) => {
    return (options.client ?? client).post<PostV1MovieByIdPreviewCandidateResponses, PostV1MovieByIdPreviewCandidateErrors, ThrowOnError>({
