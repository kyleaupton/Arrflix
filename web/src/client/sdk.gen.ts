 ...
 * Check for updates
 */
export const getV1Update = <ThrowOnError extends boolean = false>(options?: Options<GetV1UpdateData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetV1UpdateResponses, unknown, ThrowOnError>({
        url: '/v1/update',
        ...options
    });
};
